...
Route::filter('contributor',function(){
    ...
    $contributor = UserMeta::where('user_id',$id)->count();
    ...
    { 
        ...
        {
            Toastr::info("Please register as contributor");
...
//     $id = Sentry::getUser()->id;
//     $member = User::where('id',$id)->where('contributor',1)->count();

//     if($member)
//     {
//         Toastr::info("You are already member");
//         return Redirect::to('/');
//     }
