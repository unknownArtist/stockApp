		  ...
		  <div class="pure-u-1-2">
		      <div class="pure-menu pure-menu-open pure-menu-horizontal sec-navigation pure-menu-pull-right"> 
			      <ul class="sec-menu-items">
		                <li>
<!--		                link_to_route('Start Downloading', 'Become a Member', array(), array('class' => 'pure-menu-heading members-menu'))-->
 		                	<a class="pure-menu-heading members-menu" href="#">{{ Lang::get('menu.startDownloading') }} / {{ Helpers::getFullUserName()}}</a>
					             <ul id="">
					                <li><a href="/contributor/account/{{Sentry::getUser()->id}}/details">{{ Lang::get('menu.accountDetails') }}</a></li>
					                <li><a href="/user/image/upload">{{ Lang::get('menu.uploadImage') }}</a></li>
					                <li><a href="/auth/logout">{{ Lang::get('menu.signOut') }}</a></li>
						         </ul> 
		                </li>
	               <ul><!-- End std-menu-item -->
               </div><!-- End pure-menu -->
