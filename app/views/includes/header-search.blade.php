...
================================================ -->
		<button class="pure-button example" data-dropdown="#dropdown-2">{{ Lang::get('menu.refineSelection') }}</button>
...
=============================== -->
		<li class="media_type">
            ...
            <div>
                <label>
                    <input type="radio" name="image_type" value="all" checked="checked">
                    All Images
                </label>
                <label>
                ...
                <label>
                    <input type="radio" name="image_type" value="ai">
                    Illustrations
                </label>
            </div>
		</li><!-- End Media Type  -->
...
=============================== -->		
		<li class="orientation">
			...
			<div>
				<label>
					<input type="radio" name="orientation" value="all-orientations" checked="checked">
					All
				</label>
				<label>
...
================================================ -->
				   <div class="ui-widget">
			           <input type="text" name="search-term" placeholder="Search images, vectors and more" class="main-search-form-width" id="search-term" autocomplete="off">
			           <button type="submit" value="search" class="button-success pure-button">
			           	{{ Lang::get('menu.search') }}</button>
			       </div>
			       </form>	
